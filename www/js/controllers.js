...
appControllers.controller('menuCtrl', ['$rootScope', '$scope', '$http', 'tourInfo', '$ionicSlideBoxDelegate', '$state', 'appStateStore', '$ionicSideMenuDelegate', '$timeout', '$ionicScrollDelegate', '$location',
    function ($rootScope, $scope, $http, tourInfo, $ionicSlideBoxDelegate, $state, appStateStore, $ionicSideMenuDelegate, $timeout, $ionicScrollDelegate, $location) {
        $scope.showAdd = false;
