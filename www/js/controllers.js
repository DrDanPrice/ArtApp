...
appControllers.controller('mainCtrl', function ($scope, $rootScope, $window, tourInfo, $ionicSlideBoxDelegate, $stateParams, $timeout, $state, $ionicSideMenuDelegate) {
    $ionicSideMenuDelegate.$getByHandle('main-menu').canDragContent(true);
    $state.go('tour.collage', {tourID: 1});
});

appControllers.controller('artDetailCtrl', function ($scope, $rootScope, $window, tourInfo, $ionicSlideBoxDelegate, $stateParams, $ionicScrollDelegate, $state, $cordovaInAppBrowser, $ionicModal, $ionicSideMenuDelegate) {
    $ionicSideMenuDelegate.$getByHandle('main-menu').canDragContent(true);
    $rootScope.prevState = $rootScope.curState;
    $rootScope.curState = $state.current.name;
    ...
    $scope.genImList = function (artOb) {
        return "http://www.housuggest.org/images/ARtour/" + artOb.artwork_id + "/" + artOb.image.split(",")[0];
    };
...
appControllers.controller('favoriteCtrl', function ($scope, $rootScope, $window, tourInfo, $ionicSlideBoxDelegate, $stateParams, favoriteService, $state, $ionicSideMenuDelegate) {
    $ionicSideMenuDelegate.$getByHandle('main-menu').canDragContent(true);
...
appControllers.controller('arCtrl', function ($scope, $rootScope, $window, tourInfo, $ionicSlideBoxDelegate, $stateParams, favoriteService, $ionicSideMenuDelegate, $state) {
    $ionicSideMenuDelegate.$getByHandle('main-menu').canDragContent(true);
